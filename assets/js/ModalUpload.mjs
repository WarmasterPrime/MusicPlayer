...
export class ModalUpload {
	...
	static render() {
		...
		html += "</div>";
		html += "<div class='modal-form-group'>";
		html += "<label>Album Artist</label>";
		html += "<input type='text' id='upload-album-artist' />";
		html += "</div>";
		html += "<div class='modal-form-group'>";
		...
		html += "</div>";
		html += "<div class='modal-form-group'>";
		html += "<label>Composer</label>";
		html += "<input type='text' id='upload-composer' />";
		html += "</div>";
		html += "<div class='modal-form-group'>";
		...
		html += "<input type='date' id='upload-publish-date' />";
		html += "</div>";
		html += "<div class='modal-form-group'>";
		html += "<label>Source URL</label>";
		html += "<input type='url' id='upload-source-url' placeholder='https://' />";
		html += "</div>";
		html += "<div class='modal-form-group'>";
	...
	static async upload() {
		...
		formData.append("album_artist", (document.getElementById("upload-album-artist")?.value || "").trim());
		formData.append("genre", (document.getElementById("upload-genre")?.value || "").trim());
		formData.append("composer", (document.getElementById("upload-composer")?.value || "").trim());
		formData.append("publisher", (document.getElementById("upload-publisher")?.value || "").trim());
		formData.append("publish_date", (document.getElementById("upload-publish-date")?.value || "").trim());
		formData.append("source_url", (document.getElementById("upload-source-url")?.value || "").trim());
